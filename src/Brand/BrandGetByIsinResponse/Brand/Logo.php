...
namespace ContextDev\Brand\BrandGetByIsinResponse\Brand;

use ContextDev\Brand\BrandGetByIsinResponse\Brand\Logo\Color;
use ContextDev\Brand\BrandGetByIsinResponse\Brand\Logo\Mode;
use ContextDev\Brand\BrandGetByIsinResponse\Brand\Logo\Resolution;
use ContextDev\Brand\BrandGetByIsinResponse\Brand\Logo\Type;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandGetByIsinResponse\Brand\Logo\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandGetByIsinResponse\Brand\Logo\Resolution
 *
 * @phpstan-type LogoShape = array{
 *   colors?: list<\ContextDev\Brand\BrandGetByIsinResponse\Brand\Logo\Color|ColorShape>|null,
