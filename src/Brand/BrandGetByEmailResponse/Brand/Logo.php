...
use ContextDev\Brand\BrandGetByEmailResponse\Brand\Logo\Color;
use ContextDev\Brand\BrandGetByEmailResponse\Brand\Logo\Mode;
use ContextDev\Brand\BrandGetByEmailResponse\Brand\Logo\Resolution;
use ContextDev\Brand\BrandGetByEmailResponse\Brand\Logo\Type;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandGetByEmailResponse\Brand\Logo\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandGetByEmailResponse\Brand\Logo\Resolution
 *
 * @phpstan-type LogoShape = array{
 *   colors?: list<\ContextDev\Brand\BrandGetByEmailResponse\Brand\Logo\Color|ColorShape>|null,
