...
use ContextDev\Brand\BrandGetByEmailResponse\Brand\Backdrop\Color;
use ContextDev\Brand\BrandGetByEmailResponse\Brand\Backdrop\Resolution;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandGetByEmailResponse\Brand\Backdrop\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandGetByEmailResponse\Brand\Backdrop\Resolution
 *
 * @phpstan-type BackdropShape = array{
 *   colors?: list<\ContextDev\Brand\BrandGetByEmailResponse\Brand\Backdrop\Color|ColorShape>|null,
