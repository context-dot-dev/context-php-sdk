...
use ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Logo\Color;
use ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Logo\Mode;
use ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Logo\Resolution;
use ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Logo\Type;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Logo\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Logo\Resolution
 *
 * @phpstan-type LogoShape = array{
 *   colors?: list<\ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Logo\Color|ColorShape>|null,
