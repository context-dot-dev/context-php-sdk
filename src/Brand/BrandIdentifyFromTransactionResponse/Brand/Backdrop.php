...
use ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Backdrop\Color;
use ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Backdrop\Resolution;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Backdrop\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Backdrop\Resolution
 *
 * @phpstan-type BackdropShape = array{
 *   colors?: list<\ContextDev\Brand\BrandIdentifyFromTransactionResponse\Brand\Backdrop\Color|ColorShape>|null,
