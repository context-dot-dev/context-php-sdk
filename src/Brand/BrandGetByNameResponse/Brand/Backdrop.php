...
use ContextDev\Brand\BrandGetByNameResponse\Brand\Backdrop\Color;
use ContextDev\Brand\BrandGetByNameResponse\Brand\Backdrop\Resolution;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandGetByNameResponse\Brand\Backdrop\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandGetByNameResponse\Brand\Backdrop\Resolution
 *
 * @phpstan-type BackdropShape = array{
 *   colors?: list<\ContextDev\Brand\BrandGetByNameResponse\Brand\Backdrop\Color|ColorShape>|null,
