...
namespace ContextDev\Brand\BrandGetByNameResponse\Brand;

use ContextDev\Brand\BrandGetByNameResponse\Brand\Logo\Color;
use ContextDev\Brand\BrandGetByNameResponse\Brand\Logo\Mode;
use ContextDev\Brand\BrandGetByNameResponse\Brand\Logo\Resolution;
use ContextDev\Brand\BrandGetByNameResponse\Brand\Logo\Type;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandGetByNameResponse\Brand\Logo\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandGetByNameResponse\Brand\Logo\Resolution
 *
 * @phpstan-type LogoShape = array{
 *   colors?: list<\ContextDev\Brand\BrandGetByNameResponse\Brand\Logo\Color|ColorShape>|null,
