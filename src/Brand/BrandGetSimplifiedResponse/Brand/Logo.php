...
use ContextDev\Brand\BrandGetSimplifiedResponse\Brand\Logo\Color;
use ContextDev\Brand\BrandGetSimplifiedResponse\Brand\Logo\Mode;
use ContextDev\Brand\BrandGetSimplifiedResponse\Brand\Logo\Resolution;
use ContextDev\Brand\BrandGetSimplifiedResponse\Brand\Logo\Type;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandGetSimplifiedResponse\Brand\Logo\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandGetSimplifiedResponse\Brand\Logo\Resolution
 *
 * @phpstan-type LogoShape = array{
 *   colors?: list<\ContextDev\Brand\BrandGetSimplifiedResponse\Brand\Logo\Color|ColorShape>|null,
