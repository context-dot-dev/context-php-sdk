...
use ContextDev\Brand\BrandGetResponse\Brand\Backdrop\Color;
use ContextDev\Brand\BrandGetResponse\Brand\Backdrop\Resolution;
use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type ColorShape from \ContextDev\Brand\BrandGetResponse\Brand\Backdrop\Color
 * @phpstan-import-type ResolutionShape from \ContextDev\Brand\BrandGetResponse\Brand\Backdrop\Resolution
 *
 * @phpstan-type BackdropShape = array{
 *   colors?: list<\ContextDev\Brand\BrandGetResponse\Brand\Backdrop\Color|ColorShape>|null,
