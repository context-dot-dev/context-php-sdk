...
/**
 * @phpstan-type SecondaryShape = array{
 ...
 * }
 */
final class Secondary implements BaseModel
{
    /** @use SdkModel<SecondaryShape> */
    use SdkModel;
    ...
    /**
     * `new Secondary()` is missing required properties by the API.
     *
