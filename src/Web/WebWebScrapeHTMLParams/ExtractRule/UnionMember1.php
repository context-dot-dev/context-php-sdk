...
namespace ContextDev\Web\WebWebScrapeHTMLParams\ExtractRule;

use ContextDev\Core\Attributes\Optional;
use ContextDev\Core\Attributes\Required;
use ContextDev\Core\Concerns\SdkModel;
use ContextDev\Core\Contracts\BaseModel;
use ContextDev\Web\WebWebScrapeHTMLParams\ExtractRule\UnionMember1\Output;
use ContextDev\Web\WebWebScrapeHTMLParams\ExtractRule\UnionMember1\Output\UnionMember0;
use ContextDev\Web\WebWebScrapeHTMLParams\ExtractRule\UnionMember1\Type;

/**
 * @phpstan-import-type OutputVariants from \ContextDev\Web\WebWebScrapeHTMLParams\ExtractRule\UnionMember1\Output
 * @phpstan-import-type OutputShape from \ContextDev\Web\WebWebScrapeHTMLParams\ExtractRule\UnionMember1\Output
 *
...
final class UnionMember1 implements BaseModel
{
    ...
    public static function with(
        string $selector,
        string|UnionMember0|array|null $output = null,
     ...
     */
    public function withOutput(string|UnionMember0|array $output): self
    {
        $self = clone $this;
        $self['output'] = $output;
