...
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\ChangeDetection;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\Schedule;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\Status;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\Target;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\Webhook;

/**
 * An extract monitor using semantic change detection.
 *
 * @phpstan-import-type ChangeDetectionShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\ChangeDetection
 * @phpstan-import-type ScheduleShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\Schedule
 * @phpstan-import-type TargetShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\Target
 * @phpstan-import-type WebhookShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsExtractSemanticMonitor\Webhook
 *
 * @phpstan-type MonitorsExtractSemanticMonitorShape = array{
 *   id: string,
 ...
 * }
 */
final class MonitorsExtractSemanticMonitor implements BaseModel
{
    /** @use SdkModel<MonitorsExtractSemanticMonitorShape> */
    use SdkModel;
    ...
    /**
     * `new MonitorsExtractSemanticMonitor()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MonitorsExtractSemanticMonitor::with(
     *   id: ...,
     *   changeDetection: ...,
     *   createdAt: ...,
     *   name: ...,
     ...
     *
     * ```
     * (new MonitorsExtractSemanticMonitor)
     *   ->withID(...)
     *   ->withChangeDetection(...)
     *   ->withCreatedAt(...)
     *   ->withName(...)
