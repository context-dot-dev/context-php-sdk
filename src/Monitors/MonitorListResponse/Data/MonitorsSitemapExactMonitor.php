...
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\ChangeDetection;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\Schedule;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\Status;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\Target;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\Webhook;

/**
 * A sitemap monitor using exact change detection.
 *
 * @phpstan-import-type ChangeDetectionShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\ChangeDetection
 * @phpstan-import-type ScheduleShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\Schedule
 * @phpstan-import-type TargetShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\Target
 * @phpstan-import-type WebhookShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsSitemapExactMonitor\Webhook
 *
 * @phpstan-type MonitorsSitemapExactMonitorShape = array{
 *   id: string,
 ...
 * }
 */
final class MonitorsSitemapExactMonitor implements BaseModel
{
    /** @use SdkModel<MonitorsSitemapExactMonitorShape> */
    use SdkModel;
    ...
    /**
     * `new MonitorsSitemapExactMonitor()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MonitorsSitemapExactMonitor::with(
     *   id: ...,
     *   changeDetection: ...,
     *   createdAt: ...,
     *   name: ...,
     ...
     *
     * ```
     * (new MonitorsSitemapExactMonitor)
     *   ->withID(...)
     *   ->withChangeDetection(...)
     *   ->withCreatedAt(...)
     *   ->withName(...)
