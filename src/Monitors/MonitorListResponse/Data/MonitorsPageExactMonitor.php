...
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\ChangeDetection;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\Schedule;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\Status;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\Target;
use ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\Webhook;

/**
 * A page monitor using exact change detection.
 *
 * @phpstan-import-type ChangeDetectionShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\ChangeDetection
 * @phpstan-import-type ScheduleShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\Schedule
 * @phpstan-import-type TargetShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\Target
 * @phpstan-import-type WebhookShape from \ContextDev\Monitors\MonitorListResponse\Data\MonitorsPageExactMonitor\Webhook
 *
 * @phpstan-type MonitorsPageExactMonitorShape = array{
 *   id: string,
 ...
 * }
 */
final class MonitorsPageExactMonitor implements BaseModel
{
    /** @use SdkModel<MonitorsPageExactMonitorShape> */
    use SdkModel;
    ...
    /**
     * `new MonitorsPageExactMonitor()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MonitorsPageExactMonitor::with(
     *   id: ...,
     *   changeDetection: ...,
     *   createdAt: ...,
     *   name: ...,
