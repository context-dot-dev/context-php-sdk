...
use ContextDev\Monitors\MonitorRotateWebhookSecretResponse\Status;
use ContextDev\Monitors\MonitorRotateWebhookSecretResponse\Target;
use ContextDev\Monitors\MonitorRotateWebhookSecretResponse\Target\MonitorsExtractTarget;
use ContextDev\Monitors\MonitorRotateWebhookSecretResponse\Target\MonitorsPageTarget;
use ContextDev\Monitors\MonitorRotateWebhookSecretResponse\Target\MonitorsSitemapTarget;
use ContextDev\Monitors\MonitorRotateWebhookSecretResponse\Webhook;
 ...
 *
 * @phpstan-type MonitorRotateWebhookSecretResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class MonitorRotateWebhookSecretResponse implements BaseModel
{
    /** @use SdkModel<MonitorRotateWebhookSecretResponseShape> */
    use SdkModel;
    ...
    /**
     * `new MonitorRotateWebhookSecretResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MonitorRotateWebhookSecretResponse::with(
     *   id: ...,
     *   changeDetection: ...,
     *   createdAt: ...,
     *   mode: ...,
     ...
     *
     * ```
     * (new MonitorRotateWebhookSecretResponse)
     *   ->withID(...)
     *   ->withChangeDetection(...)
     *   ->withCreatedAt(...)
     *   ->withMode(...)
