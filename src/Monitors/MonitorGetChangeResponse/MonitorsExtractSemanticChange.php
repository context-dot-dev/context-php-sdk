...
use ContextDev\Monitors\MonitorGetChangeResponse\MonitorsExtractSemanticChange\ChangeDetectionType;
use ContextDev\Monitors\MonitorGetChangeResponse\MonitorsExtractSemanticChange\Evidence;
use ContextDev\Monitors\MonitorGetChangeResponse\MonitorsExtractSemanticChange\Importance;
use ContextDev\Monitors\MonitorGetChangeResponse\MonitorsExtractSemanticChange\TargetType;

/**
 * @phpstan-import-type EvidenceShape from \ContextDev\Monitors\MonitorGetChangeResponse\MonitorsExtractSemanticChange\Evidence
 *
 * @phpstan-type MonitorsExtractSemanticChangeShape = array{
 *   id: string,
 ...
 * }
 */
final class MonitorsExtractSemanticChange implements BaseModel
{
    /** @use SdkModel<MonitorsExtractSemanticChangeShape> */
    use SdkModel;
    ...
    #[Required('matched_urls', list: 'string')]
    ...
    /**
     * `new MonitorsExtractSemanticChange()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MonitorsExtractSemanticChange::with(
     *   id: ...,
     *   changeDetectionType: ...,
     *   confidence: ...,
     *   detectedAt: ...,
     ...
     *
     * ```
     * (new MonitorsExtractSemanticChange)
     *   ->withID(...)
