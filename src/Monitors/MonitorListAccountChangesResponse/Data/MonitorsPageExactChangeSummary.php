...
use ContextDev\Monitors\MonitorListAccountChangesResponse\Data\MonitorsPageExactChangeSummary\ChangeDetectionType;
use ContextDev\Monitors\MonitorListAccountChangesResponse\Data\MonitorsPageExactChangeSummary\TargetType;

/**
 * @phpstan-type MonitorsPageExactChangeSummaryShape = array{
 *   id: string,
 ...
 * }
 */
final class MonitorsPageExactChangeSummary implements BaseModel
{
    /** @use SdkModel<MonitorsPageExactChangeSummaryShape> */
    use SdkModel;
    ...
    /**
     * `new MonitorsPageExactChangeSummary()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MonitorsPageExactChangeSummary::with(
     *   id: ...,
     *   changeDetectionType: ...,
     *   detectedAt: ...,
     *   monitorID: ...,
     ...
     *
     * ```
     * (new MonitorsPageExactChangeSummary)
     *   ->withID(...)
