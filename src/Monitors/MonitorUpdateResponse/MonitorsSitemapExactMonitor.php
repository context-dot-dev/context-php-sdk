...
use ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\ChangeDetection;
use ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\Schedule;
use ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\Status;
use ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\Target;
use ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\Webhook;

/**
 * A sitemap monitor using exact change detection.
 *
 * @phpstan-import-type ChangeDetectionShape from \ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\ChangeDetection
 * @phpstan-import-type ScheduleShape from \ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\Schedule
 * @phpstan-import-type TargetShape from \ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\Target
 * @phpstan-import-type WebhookShape from \ContextDev\Monitors\MonitorUpdateResponse\MonitorsSitemapExactMonitor\Webhook
 *
