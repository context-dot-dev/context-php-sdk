...
use ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\ChangeDetection;
use ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\Schedule;
use ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\Status;
use ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\Target;
use ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\Webhook;

/**
 * A sitemap monitor using exact change detection.
 *
 * @phpstan-import-type ChangeDetectionShape from \ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\ChangeDetection
 * @phpstan-import-type ScheduleShape from \ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\Schedule
 * @phpstan-import-type TargetShape from \ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\Target
 * @phpstan-import-type WebhookShape from \ContextDev\Monitors\MonitorNewResponse\MonitorsSitemapExactMonitor\Webhook
 *
