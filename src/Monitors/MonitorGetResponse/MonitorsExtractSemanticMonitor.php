...
use ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\ChangeDetection;
use ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\Schedule;
use ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\Status;
use ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\Target;
use ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\Webhook;

/**
 * An extract monitor using semantic change detection.
 *
 * @phpstan-import-type ChangeDetectionShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\ChangeDetection
 * @phpstan-import-type ScheduleShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\Schedule
 * @phpstan-import-type TargetShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\Target
 * @phpstan-import-type WebhookShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsExtractSemanticMonitor\Webhook
 *
