...
use ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\ChangeDetection;
use ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\Schedule;
use ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\Status;
use ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\Target;
use ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\Webhook;

/**
 * A page monitor using exact change detection.
 *
 * @phpstan-import-type ChangeDetectionShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\ChangeDetection
 * @phpstan-import-type ScheduleShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\Schedule
 * @phpstan-import-type TargetShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\Target
 * @phpstan-import-type WebhookShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsPageExactMonitor\Webhook
 *
