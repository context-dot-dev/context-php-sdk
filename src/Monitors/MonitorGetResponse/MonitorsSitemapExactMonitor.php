...
use ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\ChangeDetection;
use ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\Schedule;
use ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\Status;
use ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\Target;
use ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\Webhook;

/**
 * A sitemap monitor using exact change detection.
 *
 * @phpstan-import-type ChangeDetectionShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\ChangeDetection
 * @phpstan-import-type ScheduleShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\Schedule
 * @phpstan-import-type TargetShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\Target
 * @phpstan-import-type WebhookShape from \ContextDev\Monitors\MonitorGetResponse\MonitorsSitemapExactMonitor\Webhook
 *
